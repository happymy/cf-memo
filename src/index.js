...
function serveAppPage() {
  ...
  h.push('    .sidebar { width:48px; }');
  h.push('    .sidebar .sidebar-title-text, .sidebar .add-folder,');
  h.push('    .sidebar .folder-item .folder-name, .sidebar .folder-item .folder-count,');
  h.push('    .sidebar .folder-item .folder-actions { display:none; }');
  h.push('    .sidebar .folder-item { justify-content:center; padding:12px 0; }');
